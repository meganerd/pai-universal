...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "MESSAGE", "voice_id": "a1TnjruAs5jTzdrjL8Vd", "voice_enabled": true}'
```
...
**Voice:** `curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"message": "Entering the Algorithm", "voice_id": "a1TnjruAs5jTzdrjL8Vd", "voice_enabled": true}'`
